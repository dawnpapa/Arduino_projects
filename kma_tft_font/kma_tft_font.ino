...
uint8_t hh = hour(), mm = minute(), ss = second(); 
   if (targetTime < millis()) {
    ...
    tft.setCursor(0,110);
    tft.print(year());tft.print(".");tft.print(month());tft.print(".");tft.print(day());tft.print(" ");tft.print(dayStr(weekday()));//tft.print(dayShortStr(weekday()));
    ...
    if(wifiMulti.run() == WL_CONNECTED) { 
        ...
        if(httpCode > 0) { 
          ...
          if(httpCode == HTTP_CODE_OK) { 
            ...
            tft.setCursor(0,1);
            tft.setFreeFont(FONT2);   // Select Free Serif 9 point font, could use:
            tft.setTextColor(TFT_GREEN,TFT_BLACK);tft.print("Temper");tft.setTextSize(2);tft.print("ature:  ");
            tft.setTextSize(3);tft.print("        ");tft.setCursor(200,1);
...
//            tft.println("%sms      ",w_ws_t); 
            ...
            tft.setTextSize(1);tft.setTextColor(TFT_BLUE,TFT_BLACK);tft.print("Updated time is ");tft.print(w_date);
