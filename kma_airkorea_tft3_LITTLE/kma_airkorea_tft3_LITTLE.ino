    ...
    if (ss == 60) {    // Check for roll-over
      ...
      if (mm > 59) {   // Check for roll-over
        ...
        if (hh > 23) { // Check for 24hr roll-over (could roll-over on 13)
          ...
          tft.fillRect(0,115,270,29,TFT_BLACK); //이전정보지우기
        }
      }
    }
...
//  tft.setTextSize(3);
 ...
 //           tft.setCursor(0,1);
            ...
            tft.drawString("  Welcome to Little Zone @   ",0,0,4);
...
//               wdata[] = {pm10grade,pm10,pm25grade,pm25,khigrade};
         ...
         Serial.printf("pm10:%d pm25:%d pm10G:%d pm25G:%d o3G:%d o3:%d\n",pm10,pm25,pm10grade,pm25grade,o3grade,o3);
            int xpos_air=0,ypos_air=82;
            tft.setTextColor(TFT_GREEN,TFT_BLACK);
            xpos_air+=tft.drawString("Dust(PM10)",xpos_air,ypos_air,4);
  ...
  //          xpos_air+=tft.drawString("/",xpos_air,ypos_air,4); 
             ...
             switch (pm10grade) { 
                ...
                case 3: strcpy(pm10grade_str," Bad    ");tft.setTextColor(TFT_BLACK,TFT_YELLOW);break; 
           ...
           switch (o3grade) { 
                ...
                case 3: tft.fillCircle(oz_x,oz_y,sizeC,TFT_YELLOW);tft.setTextColor(TFT_BLUE,TFT_YELLOW);break; 
