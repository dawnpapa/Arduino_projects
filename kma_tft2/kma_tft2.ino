...
uint8_t hh = hour(), mm = minute(), ss = second(); 
 ...
 //   tft.setCursor(0,120);
    ...
    xpos_date+=tft.drawNumber(year(),xpos_date,115, 4); xpos_date+=tft.drawChar('.',xpos_date,115,4);
    xpos_date+=tft.drawNumber(month(),xpos_date,115,4);xpos_date+=tft.drawChar('.',xpos_date,115,4);
    xpos_date+=tft.drawNumber(day(),xpos_date,115,4);xpos_date+=tft.drawChar(' ',xpos_date,115,4);
...
//  tft.setTextSize(3);
 ...
 //           tft.setCursor(0,1);
            ...
            tft.setTextColor(TFT_BLUE,TFT_BLACK);
            xpos_weather+=tft.drawString("Updated time is ",xpos_weather,105,1);
            tft.drawString(w_date,xpos_weather,105,1);
