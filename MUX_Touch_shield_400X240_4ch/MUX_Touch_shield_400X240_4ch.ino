...
uint16_t TS_RT = 900;//y-axis top
uint16_t TS_LEFT  = 220; //y-axis bottom
uint16_t TS_BOT = 940;//x-axis
uint16_t TS_TOP = 200;//x-axis
...
uint8_t Orientation = 0;    //0/2.PORTRAIT 1/3.landscape
